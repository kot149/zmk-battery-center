...
- (Options)
  ...
  - Pin the window open and on top
...
- `Pin window` relies on the X11 backend to stay above other windows. The app already forces X11 under a Wayland session, so it should work there too, but this has not been tested on Wayland.
